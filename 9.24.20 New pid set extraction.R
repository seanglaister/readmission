...
# # Order readmitted_patients_all_Stays by patienthealthsystemstayid, then by -(hospitaladmitoffset)
# readmitted_patients_all_Stays <- readmitted_patients_all_Stays[
#   order(readmitted_patients_all_Stays$patienthealthsystemstayid, - (readmitted_patients_all_Stays$hospitaladmitoffset)),
#   ]
# # how to check if it worked:view(readmitted_patients[ ,c(3,12)])
# 
# # EXTRACT the  first readmitted ICU stay of each patienthealthsystemstayid, = "first_ICU_Stay"
# first_ICU_Stay <- readmitted_patients_all_Stays[!duplicated(readmitted_patients_all_Stays$patienthealthsystemstayid), ]
...
#### Step 4: Segement only raedmission_time_intervals between 1 and 72 hours. Segment only those who were not discharged to the OR ####
